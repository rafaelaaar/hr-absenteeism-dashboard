...
![Absenteeism Analysis](AbsenteeismAnalysis.png)
...
![Store & Workforce Insights](Store&WorkforceInsights.png)
...
SELECT
  ROUND(AVG(AbsentHours), 2) AS AVG_hour_absent,
...
Created by Rafaela Araujo • [LinkedIn](https://www.linkedin.com/in/rafaelaaaraujo)
